...
<div style="background:#f0f9ff;border:2px solid #bae6fd;border-radius:6px;padding:10px 14px;font-size:13px;margin-top:8px">
  ...
  &nbsp;&nbsp;
  <a href="plan_scanner_prototype.html" style="color:#1565c0;font-weight:700">Prototype Shell (S16) →</a>
  &nbsp;&nbsp;
  <a href="local_state/local_persistence_report.html" style="color:#4527a0;font-weight:700">Local State (S17) →</a><br>
