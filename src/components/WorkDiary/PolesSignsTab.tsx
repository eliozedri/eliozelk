...
export function PolesSignsTab({
  ...
  const updP = (id: string, p: Partial<PoleItem>) =>
    onPolesChange(updatePole(poleItems, id, p));
  const updS = (id: string, p: Partial<SignItem>) =>
    onSignsChange(updateSign(signItems, id, p));
                ...
                >
                  <td className="px-3 py-2">
                    {item.isCustom ? (
                      <input
                        type="text"
                        value={item.name}
                        onChange={(e) => updP(item.id, { name: e.target.value })}
                        disabled={disabled}
                        placeholder="שם פריט"
                        className={txtCls}
                      />
                  ...
                  {(
                    ...
                    <td key={col} className="px-1 py-1.5 text-center">
                      <input
                        ...
                        min="0"
                        value={item[col]}
                        onChange={(e) => updP(item.id, { [col]: e.target.value })}
                        disabled={disabled}
                        className={numCls}
                      />
                    </td>
                  ...
                  <td className="px-1 py-1.5 text-center">
                    <input
                      type="text"
                      value={item.size}
                      onChange={(e) => updP(item.id, { size: e.target.value })}
                      disabled={disabled}
                      className={numCls}
                    />
                  </td>
                  <td className="px-2 py-1.5">
                    <input
                      type="text"
                      value={item.notes}
                      onChange={(e) => updP(item.id, { notes: e.target.value })}
                      disabled={disabled}
                      placeholder="הערה"
                      className={txtCls}
                    />
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              {signItems.map((item, idx) => (
                ...
                >
                  {(
                    ...
                    <td key={col} className="px-1 py-1.5 text-center">
                      <input
                        ...
                        min="0"
                        value={item[col]}
                        onChange={(e) => updS(item.id, { [col]: e.target.value })}
                        disabled={disabled}
                        className={numCls}
                      />
                    </td>
                  ))}
                  {(["angle", "frame", "profile", "signSize"] as const).map(
                    (col) => (
                      <td key={col} className="px-1 py-1.5 text-center">
                        <input
                          type="text"
                          value={item[col]}
                          onChange={(e) =>
                            updS(item.id, { [col]: e.target.value })
                          }
                          disabled={disabled}
                          className={smCls}
                        />
                  ...
                  <td className="px-2 py-1.5 text-center">
                    <input
                      type="checkbox"
                      checked={item.battery}
                      onChange={(e) =>
                        updS(item.id, { battery: e.target.checked })
                      }
                      disabled={disabled}
                  ...
                  <td className="px-2 py-1.5 text-center">
                    <input
                      ...
                      checked={item.solar}
                      onChange={(e) =>
                        updS(item.id, { solar: e.target.checked })
                      }
                      disabled={disabled}
                      className="w-4 h-4 accent-blue-600"
                    />
                  ...
                  <td className="px-1 py-1.5 text-center">
                    <input
                      ...
                      value={item.returned}
                      onChange={(e) =>
                        updS(item.id, { returned: e.target.value })
                      }
                      disabled={disabled}
                      className={numCls}
                    />
                  ...
                  <td className="px-2 py-1.5">
                    <input
                      ...
                      value={item.notes}
                      onChange={(e) =>
                        updS(item.id, { notes: e.target.value })
                      }
                      disabled={disabled}
                      placeholder="הערה"
                      className={txtCls}
        ...
        <div className="px-5 py-3 border-t border-gray-100 bg-gray-50/50">
          <p className="text-xs text-gray-400">
            10 שורות פנס — מלא רק את השורות הרלוונטיות.
          </p>
        </div>
      </div>
    </div>
